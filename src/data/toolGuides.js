...
export const toolGuides = {
  ...
  "gst-calculator": {
    "title": "GST Calculator — Online FINANCE Tool",
    "overview": "The Calciverse GST Calculator is an advanced, privacy-focused online utility engineered to provide fast, accurate, and transparent calculations. Add or remove GST from an amount at any slab rate. Designed for professionals, students, small business owners, and everyday users, this tool eliminates manual calculation errors and delivers instant visual breakdowns directly in your browser memory without requiring registration or server data submission.",
    "formula": "Result = Compute_gst_calculator(Input_Parameters)",
    "explanation": "Calculated using verified mathematical and algorithmic models tailored specifically for gst calculator.",
    "example": {
      "title": "Worked Real-World Example: GST Calculator",
      "inputs": "Standard parameters for GST Calculator",
      "steps": [
      ...
      "summary": "Instant, high-precision calculation completed for GST Calculator."
    },
    "metricsText": "Outputs generated by the GST Calculator provide actionable clarity. All calculations are executed strictly inside your local browser memory, ensuring your private data never leaves your device.",
    "useCases": [
    ...
    "faqs": [
      {
        "question": "How does the Calciverse GST Calculator work?",
        "answer": "The Calciverse GST Calculator processes your inputs instantly using standard deterministic formulas. All logic runs client-side in your browser, guaranteeing zero latency and maximum privacy."
      },
      {
        "question": "Is the GST Calculator free to use?",
        "answer": "Yes! All calculators, converters, and generators on Calciverse.in are 100% free with unlimited access, zero registration requirements, and no hidden fees."
      },
      {
        "question": "Can I save or export my GST Calculator results?",
        "answer": "Yes. You can copy output metrics directly to your clipboard or print formatted summaries to PDF using your browser print function."
      },
      {
        "question": "Is my data stored or transmitted to external servers?",
  ...
  "ideal-weight-calculator": {
    "title": "Ideal Weight Calculator — Online HEALTH Tool",
    "overview": "The Calciverse Ideal Weight Calculator is an advanced, privacy-focused online utility engineered to provide fast, accurate, and transparent calculations. A healthy weight range based on height, age and gender. Designed for professionals, students, small business owners, and everyday users, this tool eliminates manual calculation errors and delivers instant visual breakdowns directly in your browser memory without requiring registration or server data submission.",
    "formula": "Result = Compute_ideal_weight_calculator(Input_Parameters)",
    "explanation": "Calculated using verified mathematical and algorithmic models tailored specifically for ideal weight calculator.",
    "example": {
      "title": "Worked Real-World Example: Ideal Weight Calculator",
      "inputs": "Standard parameters for Ideal Weight Calculator",
      "steps": [
        "Enter your specific parameters into the interactive input fields above.",
        "Our client-side engine parses your inputs and applies standard mathematical algorithms instantly.",
        "Review your calculated outputs, summary metrics, and visual breakdowns with 100% data privacy."
      ],
      "summary": "Instant, high-precision calculation completed for Ideal Weight Calculator."
    },
    "metricsText": "Outputs generated by the Ideal Weight Calculator provide actionable clarity. All calculations are executed strictly inside your local browser memory, ensuring your private data never leaves your device.",
    "useCases": [
      "Professional Planning: Evaluate quantitative decisions before making commitments.",
      "Educational & Verification: Verify manual calculations, homework, or invoice billing figures.",
      "Personal Optimization: Compare multiple scenarios side-by-side to choose the optimal path."
    ...
    "faqs": [
      {
        "question": "How does the Calciverse Ideal Weight Calculator work?",
        "answer": "The Calciverse Ideal Weight Calculator processes your inputs instantly using standard deterministic formulas. All logic runs client-side in your browser, guaranteeing zero latency and maximum privacy."
      },
      {
      ...
      {
        "question": "Can I save or export my Ideal Weight Calculator results?",
        "answer": "Yes. You can copy output metrics directly to your clipboard or print formatted summaries to PDF using your browser print function."
      },
      {
        "question": "Is my data stored or transmitted to external servers?",
  ...
  "number-to-words-converter": {
    "title": "Number to Words Converter — Online MATH Tool",
    "overview": "The Calciverse Number to Words Converter is an advanced, privacy-focused online utility engineered to provide fast, accurate, and transparent calculations. Spell out a number in words, useful for cheques and forms. Designed for professionals, students, small business owners, and everyday users, this tool eliminates manual calculation errors and delivers instant visual breakdowns directly in your browser memory without requiring registration or server data submission.",
    "formula": "Result = Compute_number_to_words_converter(Input_Parameters)",
    "explanation": "Calculated using verified mathematical and algorithmic models tailored specifically for number to words converter.",
    "example": {
      "title": "Worked Real-World Example: Number to Words Converter",
      "inputs": "Standard parameters for Number to Words Converter",
      "steps": [
        "Enter your specific parameters into the interactive input fields above.",
        "Our client-side engine parses your inputs and applies standard mathematical algorithms instantly.",
        "Review your calculated outputs, summary metrics, and visual breakdowns with 100% data privacy."
      ],
      "summary": "Instant, high-precision calculation completed for Number to Words Converter."
    },
    "metricsText": "Outputs generated by the Number to Words Converter provide actionable clarity. All calculations are executed strictly inside your local browser memory, ensuring your private data never leaves your device.",
    "useCases": [
      "Professional Planning: Evaluate quantitative decisions before making commitments.",
      "Educational & Verification: Verify manual calculations, homework, or invoice billing figures.",
      "Personal Optimization: Compare multiple scenarios side-by-side to choose the optimal path."
    ...
    "faqs": [
      {
        "question": "How does the Calciverse Number to Words Converter work?",
        "answer": "The Calciverse Number to Words Converter processes your inputs instantly using standard deterministic formulas. All logic runs client-side in your browser, guaranteeing zero latency and maximum privacy."
      },
      {
      ...
      {
        "question": "Can I save or export my Number to Words Converter results?",
        "answer": "Yes. You can copy output metrics directly to your clipboard or print formatted summaries to PDF using your browser print function."
      },
      {
        "question": "Is my data stored or transmitted to external servers?",
  ...
  "mortgage-calculator": {
    "title": "Mortgage Loan Calculator — Online FINANCE Tool",
    "overview": "The Calciverse Mortgage Loan Calculator is an advanced, privacy-focused online utility engineered to provide fast, accurate, and transparent calculations. Estimate home mortgage monthly payments and total interest. Designed for professionals, students, small business owners, and everyday users, this tool eliminates manual calculation errors and delivers instant visual breakdowns directly in your browser memory without requiring registration or server data submission.",
    "formula": "Result = Compute_mortgage_calculator(Input_Parameters)",
    "explanation": "Calculated using verified mathematical and algorithmic models tailored specifically for mortgage loan calculator.",
    "example": {
      "title": "Worked Real-World Example: Mortgage Loan Calculator",
      "inputs": "Standard parameters for Mortgage Loan Calculator",
      "steps": [
        "Enter your specific parameters into the interactive input fields above.",
        "Our client-side engine parses your inputs and applies standard mathematical algorithms instantly.",
        "Review your calculated outputs, summary metrics, and visual breakdowns with 100% data privacy."
      ],
      "summary": "Instant, high-precision calculation completed for Mortgage Loan Calculator."
    },
    "metricsText": "Outputs generated by the Mortgage Loan Calculator provide actionable clarity. All calculations are executed strictly inside your local browser memory, ensuring your private data never leaves your device.",
    "useCases": [
      "Professional Planning: Evaluate quantitative decisions before making commitments.",
      "Educational & Verification: Verify manual calculations, homework, or invoice billing figures.",
      "Personal Optimization: Compare multiple scenarios side-by-side to choose the optimal path."
    ...
    "faqs": [
      {
        "question": "How does the Calciverse Mortgage Loan Calculator work?",
        "answer": "The Calciverse Mortgage Loan Calculator processes your inputs instantly using standard deterministic formulas. All logic runs client-side in your browser, guaranteeing zero latency and maximum privacy."
      },
      {
      ...
      {
        "question": "Can I save or export my Mortgage Loan Calculator results?",
        "answer": "Yes. You can copy output metrics directly to your clipboard or print formatted summaries to PDF using your browser print function."
      },
      {
        "question": "Is my data stored or transmitted to external servers?",
